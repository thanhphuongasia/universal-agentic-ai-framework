...
These fakes are stable public API — product teams should import from ``ryuu._testing``.
"""
...
class FakeKnowledgeBackbone:
    ...
    from ryuu.knowledge.backbone import BackboneType  # noqa: PLC0415
    ...
    def __post_init__(self) -> None:
        from ryuu.knowledge.backbone import BackboneType
...
class FakeIntentAnalyzer:
    ...
    def __init__(self, default_intent: Any = None) -> None:
        from ryuu.intent.models import DIRECT, ComplexityLevel, StructuredIntent
...
class FakeWorkflowEngine:
    ...
    def _next_result(self, workflow_id: str) -> Any:
        from ryuu_workflow.engine import WorkflowResult, WorkflowStatus
